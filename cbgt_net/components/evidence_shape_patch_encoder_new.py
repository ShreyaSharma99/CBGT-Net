...
class EvidenceShapePatchEncoderNew(keras.layers.Layer):
    """
    ...
    def __init__(self, num_categories, **kwargs):
        ...
        super(EvidenceShapePatchEncoderNew, self).__init__()
        ...
        self._encoder.add(keras.layers.Flatten())
        self._encoder.add(keras.layers.Dense(512, activation='relu'))
        self._encoder.add(tf.keras.layers.Dropout(0.2))
        self._encoder.add(keras.layers.Dense(256, activation='relu'))
        self._encoder.add(tf.keras.layers.Dropout(0.2))
        self._encoder.add(keras.layers.Dense(128, activation='relu'))
        self._encoder.add(keras.layers.Dense(self._evidence_dim, activation=self._output_activation))
